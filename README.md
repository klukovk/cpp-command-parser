...
## Final Notes
This project was created to provide a simple yet useful CLI parser, avoiding complex and hard-to-read boilerplate code. I tried to keep the architecture as straightforward as possible. I would highly appreciate any issue tickets or reports regarding code bugs, missing features, or documentation improvements!
